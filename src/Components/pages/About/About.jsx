        ...
        <div className="about-con fade-in">
          ...
          <div className="a-sec">
            ...
            <p className="a-sec-para">
              ...
              <p>
                I am an ambitious{" "}
                <strong>Computer Science and Engineering student</strong>,
                driven by my passion for technology and problem-solving. With a
                strong foundation in web development and a commitment to
                lifelong learning, I aim to create digital solutions that are
                innovative, functional, and impactful. <br />
                <br />
                ...
                designing sleek, responsive interfaces to managing data in
                dynamic databases, I approach every project with curiosity and a
                focus on delivering quality. <br />
                <br />
          ...
          <div className="a-sec">
            ...
            <p className="a-sec-para">
              ...
              boundaries. With a passion for learning and a collaborative
              mindset, I seek opportunities to work on impactful projects,
              exchange ideas, and contribute to transformative solutions that
          ...
          <div className="a-sec">
            ...
            <a href="/education">
              ...
              <p className="a-sec-para">
                ...
                programming, software development, and problem-solving. Learn
                how my coursework, projects, and real-world applications have
                shaped my technical expertise and prepared me to tackle complex
                challenges with confidence and creativity.
              </p>
            </a>
            <a href="/skills">
              👉🏻Explore My Technical and Creative Skillset👈🏻
              <p className="a-sec-para">
                ...
                engaging digital experiences. See how my ability to merge logic
                and creativity enables me to approach problem-solving with
                innovation, precision, and a relentless drive for excellence.
              </p>
            </a>
          </div>
        </div>
